...
public class CssCalcTests
{
    ...
    public void Vh_100_EqualsViewportHeight()
    {
        ...
        Assert.Equal(1080, style.Height, 0.01f);
    }
    ...
    public void Vw_50_EqualsHalfViewportWidth()
    {
        ...
        Assert.Equal(960, style.Width, 0.01f);
    }
    ...
    public void Vmin_UsesSmaller()
    {
        ...
        Assert.Equal(108, style.Width, 0.01f); // 10% of 1080
    }
    ...
    public void Vmax_UsesLarger()
    {
        ...
        Assert.Equal(192, style.Width, 0.01f); // 10% of 1920
    }
    ...
    public void Calc_SimpleAddition()
    {
        ...
        Assert.Equal(150, style.Width, 0.01f);
    }
    ...
    public void Calc_SimpleSubtraction()
    {
        ...
        Assert.Equal(170, style.Width, 0.01f);
    }
    ...
    public void Calc_Multiplication()
    {
        ...
        Assert.Equal(50, style.Width, 0.01f);
    }
    ...
    public void Calc_Division()
    {
        ...
        Assert.Equal(25, style.Width, 0.01f);
    }
    ...
    public void Calc_MixedUnits_PxAndVh()
    {
        ...
        Assert.Equal(560, style.Height, 0.01f); // 540 + 20
    }
    ...
    public void Calc_MixedUnits_PxAndVw()
    {
        ...
        Assert.Equal(1880, style.Width, 0.01f);
    }
    ...
    public void Calc_EmUnits()
    {
        ...
        Assert.Equal(180, style.Width, 0.01f); // 10*16 + 20
    }
    ...
    public void Calc_RemUnits()
    {
        ...
        Assert.Equal(90, style.Width, 0.01f); // 5*16 + 10
    }
    ...
    public void Calc_Nested_Parens()
    {
        ...
        Assert.Equal(300, style.Width, 0.01f);
    }
    ...
    public void Calc_InvalidExpression_ReturnsZero()
    {
        ...
        Assert.Equal(0, style.Width, 0.01f); // calc fallback is 0 for invalid
    }
    ...
    public void CalcExpression_VhVw()
    {
        ...
        Assert.Equal(1500, result, 0.01f); // 540 + 960
    }

    [Fact]
    public void Calc_DivisionByZero_HandlesGracefully()
    {
        // calc(100px / 0) should not crash — returns 0 or infinity
        var style = Apply("width", "calc(100px / 0)");
        Assert.True(float.IsInfinity(style.Width) || style.Width == 0 || float.IsNaN(style.Width));
    }
}
